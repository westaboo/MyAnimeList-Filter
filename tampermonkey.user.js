...
// @version      1.0.0
// @description  remove anime from myanimelist
...
(function() {
    ...
    for (var j = 0; j < anime_list.length; j++)
    {
        var rank = anime_list[j].getElementsByClassName('top-anime-rank-text')[0];
        rank.innerHTML = j + 1 + beginning;
    }
})();